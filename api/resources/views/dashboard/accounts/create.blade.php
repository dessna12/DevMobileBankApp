                ...
                <div class="p-6 text-gray-900">
                  ...
                  <form action="{{ route('accounts.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" name="balance" id="balance" placeholder="Balance" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('balance') border-red-500 @enderror" value="{{ old('balance') }}">
                      @error('balance')
                        <div class="text-red-500 mt-2 text-sm">
                          {{ $message }}
                        </div>
